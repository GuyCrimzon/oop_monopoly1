package main.project.services;

import main.project.model.Game;
import main.project.model.Player;
import main.project.model.PlayerStatus;
import main.project.model.cards.Card;
import main.project.model.cards.CardType;
import main.project.model.cards.CardWithProperty;
        ...
        if (p.getStatus() == PlayerStatus.STOP) {
            ...
            switch (nextCard.getCardType()) {
                case CARD_WITH_PROPERTY:
                    switch (status) {
                        case 0:
                            sb.append("The player did not buy anything\n");
                            break;
                        case 1:
